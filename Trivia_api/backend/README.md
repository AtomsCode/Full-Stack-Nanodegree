...
- Sample: `curl http://127.0.0.1:5000/questions -X POST -H "Content-Type: application/json" -d '{
            "question": "Do You know udacity ?",
            "answer": "Yes, my favorite place to learn !",
            "difficulty": 6,
            "category": "6"
        }'`
...
- Sample: `curl http://127.0.0.1:5000/questions/search -X POST -H "Content-Type: application/json" -d '{"searchTerm": "udacity"}'`
